//! Self-contained SHA-256 (FIPS 180-4) used for the series digest and for pinning fixtures by hash.
//!
//! Written in-crate so `weightsim` has zero dependencies. It is verified in the tests against the NIST test vectors
